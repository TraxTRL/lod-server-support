...
- **Per-world LOD distance limits** — Server admins can override the default distance for individual worlds; the limit follows players when they change dimensions.
...
- **Platforms** — Fabric, Paper/Purpur and NeoForge on Minecraft 26.2. Folia remains experimental and NeoForge remains best-effort. Far-player display improvements apply to the Fabric client; the NeoForge client does not render far players.
